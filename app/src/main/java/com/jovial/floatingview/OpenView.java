...
//        Bitmap bmp = BitmapFactory.decodeResource(getContext().getResources(),R.drawable.dialog_bg );
//        BitmapDrawable bd = new BitmapDrawable(createBlurBitmap(bmp,50));
////        BitmapDrawable bd = new BitmapDrawable(blurBitmap(bmp,getContext()));
//        getWindow().getDecorView().setBackground(bd);
        getWindow().getDecorView().setBackground(getContext().getResources().getDrawable(R.drawable.dialog_dv_bg));
    }
